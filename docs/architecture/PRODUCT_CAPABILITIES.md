...
## Phase 18 Image Upscale v0.1 — 18A–18E verified; 18F product proof pending
...
- 18E changes no schema, worker deployment, provider routing, production app deployment or scheduler state. Phase 18F remains required for dedicated product/live proof and final Phase 18 closure.
