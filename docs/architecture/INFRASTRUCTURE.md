...
- The whole-product audit remains open for controlled production coverage rather than a reproduced P0–P3 defect. QA-001–QA-003 remain audit-roadmap work; automatic Git → Vercel deployment remains disabled.
