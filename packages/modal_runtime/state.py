...
def _persistence_client():
    ...
    database_mode = str(os.getenv("RENDERLAB_MODAL_STATE_DB_MODE") or os.getenv("RENDERLAB_RUNTIME_DB_MODE") or "supabase_postgres").strip() or "supabase_postgres"
    ...
    profile = PersistenceProfile(
        ...
        application_name="RenderLab-modal-runtime-state",
    )
