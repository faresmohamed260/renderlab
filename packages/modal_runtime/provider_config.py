...
def _persistence_client():
    database_url = str(os.getenv("RENDERLAB_MODAL_STATE_DB_URL") or os.getenv("RENDERLAB_RUNTIME_DB_URL") or "").strip()
    database_mode = (
        str(os.getenv("RENDERLAB_MODAL_STATE_DB_MODE") or os.getenv("RENDERLAB_RUNTIME_DB_MODE") or "supabase_postgres").strip()
        or "supabase_postgres"
    )
    local_storage_root_dir = str(os.getenv("RENDERLAB_RUNTIME_LOCAL_STORAGE_ROOT") or "").strip() or "analysis_outputs/unified_storage"
    supabase_api_url = str(
        os.getenv("RENDERLAB_SUPABASE_STORAGE_API_URL")
        or os.getenv("SUPABASE_STORAGE_API_URL")
        or os.getenv("RENDERLAB_SUPABASE_API_URL")
        or os.getenv("SUPABASE_API_URL")
        or os.getenv("RENDERLAB_SUPABASE_URL")
        or os.getenv("SUPABASE_URL")
        or ""
    ).strip()
    supabase_service_role_key = str(
        os.getenv("RENDERLAB_SUPABASE_SERVICE_ROLE_KEY")
    ...
    profile = PersistenceProfile(
        ...
        application_name="RenderLab-modal-provider-config",
