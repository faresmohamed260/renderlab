...
- The whole-product audit remains open for the other #278 roadmap slices. QA-004 now has an execution-ready contract at `docs/audits/QA_004_ACCOUNT_SECURITY_DATA_PRODUCTION_AUDIT_CONTRACT.md`; its production run is not yet performed. QA-005 remains roadmap-only until QA-004 evidence exists. No P0–P3 defect is currently reproduced in completed coverage.
